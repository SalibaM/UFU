...
int main(){
    ...
    do{
        ...
        printf("16.Exibir aluno com maior nota.\n");
        printf("17.Remover quantidade de nos.\n");
        printf("18.Sair.\n");
        ...
        switch(opcao){
            ...
            case 16:
                ...
                if(opcaolista==1){
                    if(maiorNota(l,it2)==0){
                        printf("Aluno de maior nota encontrado. Dados:\n");
                        printf("Matricula:%d\n",it2->mat);
                        printf("Nome:%s\n",it2->nome);
                        printf("N1:%f\n",it2->n1);
                    } else {
            ...
            case 17:
                ...
                printf("Qual lista voce deseja remover? (1 ou 2):");
                scanf("%d",&opcaolista);

                printf("Digite a quantidade de nos que serao removidos:");
                scanf("%d",&qntd);
