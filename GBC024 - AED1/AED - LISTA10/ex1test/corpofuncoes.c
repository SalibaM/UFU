...
int ordenarLista(Lista *l){
    ...
    No *noLista = l->inicio;
    No *noSwap = (No *)malloc(sizeof(No));

    while(noLista!=NULL){
        No *noAux = noLista->prox;
        while(noAux!=NULL){
            if(noAux->valor.mat<noLista->valor.mat){
                noSwap->valor = noLista->valor;
                noLista->valor=noAux->valor;
                noAux->valor=noSwap->valor;
                noLista = noLista->prox;
            }
            noAux = noAux->prox;
